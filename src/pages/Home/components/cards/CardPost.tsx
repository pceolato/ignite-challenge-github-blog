...
export function CardPost({ id, title, description, date }: CardPostProps) {
    return (
        <NavLink to={`posts/${id}`} className="max-w-[416px] w-full p-8 flex flex-col gap-5 bg-base-post rounded-[10px] border-2 border-transparent hover:border-2 hover:border-base-label">
